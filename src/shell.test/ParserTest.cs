...
public class ParserTest
{
    ...
    public void CanParseManyAssignments() {
        ...
        Assert.Single(s);
        Assert.Equal("[ASS 'x'='4', 'y'='2', 'r'='m', 'r'='f']", s.FirstOrDefault()?.ToDebugString());
    }
    ...
    public void CanParseCommandWithOneManyAssignmentsAndManyArguments() {
        ...
        Assert.Single(s);
        Assert.Equal("[CMD: [ASS 'x'='4', 'y'='2'] 'cmnd' a, b, c, d]", s.FirstOrDefault()?.ToDebugString());
    }
    ...
    public void CanParseManyVariables() {
        ...
        Assert.Single(s);
        Assert.Equal("[TMP: 'x={$$$} {$$$}{$$$} {$$$} {$$$}' $y, $a, $b, $c, $d ]", s.FirstOrDefault()?.ToDebugString());
    }
    ...
    public void CanParseStrongQuoteHard() {
        ...
        Assert.Single(s);
        Assert.Equal("[CMD: [ASS 'x'='oo ' oo'] 'abc d ef' g]", s.FirstOrDefault()?.ToDebugString());
    }
